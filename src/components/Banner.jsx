    ...
    <div className='bg-gradient-to-b from-gray-50 to-yellow-100 py-5 md:py-0'>
       <div className="mx-auto min-h-screen md:flex items-center gap-5 w-11/12">
        <div className="md:w-1/2">
            ...
            <div className='md:w-1/2'>
                <h1 className='font-bold mb-3 text-4xl'> <Typewriter text={["Innovation at Your Fingertips", "Power, Performance, Precision", "Transform Your Digital World"]} delay={1500} loop={true} speed={100} />  </h1>

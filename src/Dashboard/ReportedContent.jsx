...
import ReportedProductItem from "../items/ReportedProductItems";
...
export default function ReportedContent() {
  ...
  return (
    <div className="mx-auto w-11/12">
      <Helmet>
        <title> Reported Products - TechProd </title>
      </Helmet>
      <h2 className="md:text-3xl text-center font-bold py-5"> Reported Products </h2>
      <div className="overflow-x-auto">
        <table className="table my-3">
          ...
          <tbody>
            {products.map((product, index) => <ReportedProductItem product={product} handleDeleteProduct={handleDeleteProduct} key={index}></ReportedProductItem>)}
